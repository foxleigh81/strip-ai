...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 p-4">
      <div className="mx-auto max-w-4xl space-y-8">
            ...
            <div className="flex gap-2">
              ...
              <Button variant="outline" onClick={clearAll} aria-label="Clear all text">
                <Suspense fallback={<div className="h-4 w-4" />}>
                  <RotateCcw className="h-4 w-4 text-gray-600 dark:text-white" />
                </Suspense>
              </Button>
            </div>
        ...
        <div className="rounded-lg bg-white/50 dark:bg-gray-800/50 p-6">
          ...
          <div className="grid gap-4 md:grid-cols-6 text-sm text-gray-600 dark:text-gray-300">
            ...
            <div>
              <h3 className="font-medium mb-1 text-gray-800 dark:text-gray-100">En-dash (–)</h3>
              <p>Medium-length dash, often used for ranges (e.g., pages 10–20)</p>
            </div>
            <div>
              <h3 className="font-medium mb-1 text-gray-800 dark:text-gray-100">Smart Quotes</h3>
              <p>Curved quotation marks (" ") often added by word processors</p>
            </div>
            <div>
              <h3 className="font-medium mb-1 text-gray-800 dark:text-gray-100">Section Breaks</h3>
